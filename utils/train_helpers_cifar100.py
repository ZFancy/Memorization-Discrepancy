...
def prepare_train_data(args, shuffle=False):
	...
	trset = datasets.CIFAR100(root='~/data/cifar100', train=True, download=True, transform=tr_transforms)
...
def prepare_test_data(args, use_transforms=True, shuffle=False):
	...
	teset = datasets.CIFAR100(root='~/data/cifar100', train=False, download=True, transform=te_transforms_local)
