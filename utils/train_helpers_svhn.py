...
def prepare_train_data(args, shuffle=False):
	...
	trset = datasets.SVHN(root='~/data/svhn', split='train', download=True, transform=tr_transforms)
...
def prepare_test_data(args, use_transforms=True, shuffle=False):
	...
	teset = datasets.SVHN(root='~/data/svhn', split='test', download=True, transform=te_transforms_local)
